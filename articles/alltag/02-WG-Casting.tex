...
\begin{antwort}
	\begin{align*}
		...
		& {\color{OliveGreen}\left\downarrow\ r \text{ aus dem Integral nach vorne ziehen }\right.} \\[0.5em]
		& {}= \frac r N\int_{r+1}^{N+1} \frac{1}{x-1}\mathrm{dx} \\[0.5em]
		& {\color{OliveGreen}\left\downarrow\ \text{Stammfunktion von } \frac{1}{x-1}
		...
		& {\color{OliveGreen}\left\downarrow\ \text{Rechenregeln des Logarithmus} \right.} \\[0.5em]
